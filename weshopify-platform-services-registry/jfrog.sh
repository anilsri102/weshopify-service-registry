...
cp $ARTIFACTORY_ARTIFACT_NAME-$ARTIFACTORY_VERSION_WITHTIME_STAMP.jar target/$ARTIFACTORY_NAME.jar
rm $ARTIFACTORY_ARTIFACT_NAME-$ARTIFACTORY_VERSION_WITHTIME_STAMP.jar
